...
pub fn compile_with_native<T: Compilable>(context: &CodegenContext, source: T) -> GeneratedModule<'_> {
    let functions = vec![
        ...
        ("STRING_TO_CHAR", iec61131std::string_conversion::STRING_TO_CHAR as usize),
        ("WSTRING_TO_WCHAR", iec61131std::string_conversion::WSTRING_TO_WCHAR as usize),
        ("CHAR_TO_STRING", iec61131std::string_conversion::CHAR_TO_STRING as usize),
        ...
        ("__STRING_GREATER", iec61131std::string_functions::__STRING_GREATER as usize),
        ("__WSTRING_GREATER", iec61131std::string_functions::__WSTRING_GREATER as usize),
        ("__STRING_EQUAL", iec61131std::string_functions::__STRING_EQUAL as usize),
        ("__WSTRING_EQUAL", iec61131std::string_functions::__WSTRING_EQUAL as usize),
        ("__STRING_LESS", iec61131std::string_functions::__STRING_LESS as usize),
        ("__WSTRING_LESS", iec61131std::string_functions::__WSTRING_LESS as usize),
