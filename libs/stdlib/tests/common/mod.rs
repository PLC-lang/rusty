...
pub fn compile_with_native<T: Compilable>(context: &CodegenContext, source: T) -> GeneratedModule {
    let functions = vec![
        ...
        ("GT__STRING", iec61131std::string_functions::__GT__STRING as usize),
        ("GT__WSTRING", iec61131std::string_functions::__GT__WSTRING as usize),
        ("GE__STRING", iec61131std::string_functions::__GE__STRING as usize),
        ("GE__WSTRING", iec61131std::string_functions::__GE__WSTRING as usize),
        ("EQ__STRING", iec61131std::string_functions::__EQ__STRING as usize),
        ("EQ__WSTRING", iec61131std::string_functions::__EQ__WSTRING as usize),
        ("LE__STRING", iec61131std::string_functions::__LE__STRING as usize),
        ("LE__WSTRING", iec61131std::string_functions::__LE__WSTRING as usize),
        ("LT__STRING", iec61131std::string_functions::__LT__STRING as usize),
        ("LT__WSTRING", iec61131std::string_functions::__LT__WSTRING as usize),
        ("NE__STRING", iec61131std::string_functions::__NE__STRING as usize),
        ("NE__WSTRING", iec61131std::string_functions::__NE__WSTRING as usize),
