...
pub unsafe extern "C" fn DT_TO_STRING(dest: *mut u8, input: i32) {
    let input_nanos = (input as u32 as i64) * NANOS_PER_SECOND as i64;
    write_date_time_to_string(input_nanos, "DT#", DT_STRING_LENGTH, dest);
}
...
pub unsafe extern "C" fn DATE_TO_STRING(dest: *mut u8, input: i32) {
    let input_nanos = (input as u32 as i64) * NANOS_PER_SECOND as i64;
    write_date_to_string(input_nanos, "D#", DATE_STRING_LENGTH, dest);
}
...
pub unsafe extern "C" fn TOD_TO_STRING(dest: *mut u8, input: i32) {
    let input_nanos = (input as u32 as i64) * NANOS_PER_MILLISECOND as i64;
    write_time_of_day_to_string(input_nanos, "TOD#", TOD_STRING_LENGTH, dest);
}
