...
The book lives in `book/` as plain markdown files. It has two parts, `user/` and `technical/`. Only `technical/` is in scope for this guide; `user/GUIDE.md` covers the other part.
