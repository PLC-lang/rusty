...
> **Tip:** Diagnostic overrides can also be embedded in a [Compatibility Profile](./compatibility_profiles.md)
> via its `diagnostics` section. This lets you combine diagnostic overrides with behavior flags in a single file.
