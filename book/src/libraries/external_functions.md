...
To use timers and any other Standard Library Function Block with the RuSTy compiler, copy-paste an external outline from the `stdlib` source code into your source code. You must still link with the Standard Library to execute this example program.
