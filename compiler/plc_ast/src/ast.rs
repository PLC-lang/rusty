...
impl ConfigVariable {
    pub fn new(name_segments: Vec<String>, data_type: DataTypeDeclaration, address: AstNode, location: SourceLocation) -> Self {
...
__init_var_conf() {
    qualified globals := mangled_hardware_variable;
}
