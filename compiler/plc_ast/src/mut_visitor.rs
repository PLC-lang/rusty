    ...
    V: AstVisitorMut,
{
    for b in blocks {
        ...
        visit_all_nodes!(visitor, &mut b.body);
    }
}
...
impl WalkerMut for HardwareAccess {
    ...
    where
        V: AstVisitorMut,
    {
        visit_all_nodes!(visitor, &mut self.address);
    }
}
...
impl WalkerMut for ReturnStatement {
    ...
    where
        V: AstVisitorMut,
    {
        visit_all_nodes!(visitor, &mut self.condition);
    }
}
...
impl WalkerMut for UserTypeDeclaration {
        ...
        V: AstVisitorMut,
    {
        ...
        visit_all_nodes!(visitor, &mut self.initializer);
    }
}
