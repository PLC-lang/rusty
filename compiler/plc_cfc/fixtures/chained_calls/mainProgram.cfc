...
<ppx:RelPosition x="90" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:Block" typeName="myMul" globalId="9">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
...
<ppx:RelPosition x="0" y="50"/>
<ppx:Connection refConnectionPointOutId="4">
    <ppx:RelPosition x="460" y="90"/>
    <ppx:RelPosition x="460" y="130"/>
    <ppx:RelPosition x="350" y="130"/>
    <ppx:RelPosition x="350" y="90"/>
</ppx:Connection>
                            </ppx:ConnectionPointIn>
                        </ppx:InputVariable>
                    </ppx:InputVariables>
...
<ppx:RelPosition x="90" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="localResultA" globalId="11">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="4"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="620" y="60"/>
                    <ppx:Size x="110" y="20"/>
                    <ppx:ConnectionPointIn>
