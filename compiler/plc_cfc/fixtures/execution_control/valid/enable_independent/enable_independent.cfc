...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="enable_independent">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM enable_independent
VAR
    a : counter;
    b : counter;
    t1 : BOOL;
    ...
    <ppx:MainBody>
        <ppx:BodyContent xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ppx:FBD">
            <ppx:Network>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="t1" globalId="12">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="t2" globalId="14">
...
<ppx:RelPosition x="130" y="50"/>
                ...
                <ppx:FbdObject xsi:type="ppx:Block" typeName="counter" instanceName="b" globalId="3">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
