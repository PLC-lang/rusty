...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="variadic_unwired">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM variadic_unwired
VAR
x, z, result: DINT; 
END_VAR
</bmx:TextDeclaration>
...
<ppx:RelPosition x="80" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="x" globalId="3">
                    <ppx:RelPosition x="200" y="170"/>
                    <ppx:Size x="80" y="20"/>
                    <ppx:ConnectionPointOut connectionPointOutId="4">
                        <ppx:RelPosition x="80" y="10"/>
                    </ppx:ConnectionPointOut>
                </ppx:FbdObject>
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="z" globalId="5">
                    <ppx:RelPosition x="200" y="210"/>
                    <ppx:Size x="80" y="20"/>
