...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="generic_chain">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM generic_chain
VAR
    a, b : INT;
    c : DINT;
    result : DINT;
...
<ppx:Connection refConnectionPointOutId="3"/>
                    ...
                    <ppx:OutputVariables>
                        <ppx:OutputVariable parameterName="myGenAdd" negated="false">
...
<ppx:RelPosition x="130" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:Block" typeName="myGenAdd" globalId="5">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="1"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="800" y="370"/>
                    <ppx:Size x="130" y="60"/>
                    <ppx:InOutVariables/>
                    <ppx:InputVariables>
                        <ppx:InputVariable parameterName="a" negated="false">
...
<ppx:RelPosition x="130" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="a" globalId="8">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="b" globalId="9">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="c" globalId="10">
                    <ppx:RelPosition x="680" y="410"/>
                    <ppx:Size x="80" y="20"/>
