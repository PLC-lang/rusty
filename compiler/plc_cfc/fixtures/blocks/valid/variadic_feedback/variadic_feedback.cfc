...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="variadic_feedback">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM variadic_feedback
VAR
    seed : DINT;
    acc : DINT;
END_VAR
...
<ppx:RelPosition x="80" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="seed" globalId="7">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="acc" globalId="13">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
