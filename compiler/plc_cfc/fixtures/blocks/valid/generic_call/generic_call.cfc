...
<ppx:Function xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="generic_call">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>FUNCTION generic_call : DINT
VAR_INPUT
    in1, in2 : DINT;
...
<ppx:RelPosition x="130" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="in1" globalId="5">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="in2" globalId="6">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="generic_call" globalId="7">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
