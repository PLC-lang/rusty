...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="add_chain">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM add_chain
VAR
a,b,c,result: DINT;
END_VAR 
</bmx:TextDeclaration>
...
<ppx:RelPosition x="80" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="a" globalId="3">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="b" globalId="5">
                    <ppx:RelPosition x="310" y="230"/>
                    <ppx:Size x="80" y="20"/>
                    <ppx:ConnectionPointOut connectionPointOutId="6">
                        <ppx:RelPosition x="80" y="10"/>
                    </ppx:ConnectionPointOut>
                </ppx:FbdObject>
                <ppx:FbdObject xsi:type="ppx:Block" typeName="ADD" globalId="7">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="1"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="600" y="190"/>
                    <ppx:Size x="80" y="60"/>
                    <ppx:InOutVariables/>
                    <ppx:InputVariables>
                        <ppx:InputVariable parameterName="IN1" negated="false">
...
<ppx:RelPosition x="80" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="c" globalId="9">
                    <ppx:RelPosition x="500" y="230"/>
                    <ppx:Size x="80" y="20"/>
