    ...
    <ppx:MainBody>
        <ppx:BodyContent xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ppx:FBD">
            <ppx:Network>
                ...
                <ppx:FbdObject xsi:type="ppx:Block" typeName="myFunc" globalId="3">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                    ...
                    <ppx:OutputVariables>
                        <ppx:OutputVariable parameterName="myFunc" negated="false">
                            <ppx:ConnectionPointOut connectionPointOutId="4">
                                <ppx:RelPosition x="90" y="30"/>
                            </ppx:ConnectionPointOut>
                        </ppx:OutputVariable>
                        <ppx:OutputVariable parameterName="extra" negated="false">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="localResult" globalId="6">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
