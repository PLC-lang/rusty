...
VAR
	localA, localB: DINT;
	localResultA, localResultB: DINT;
END_VAR</content>
            </textDeclaration>
        </ppx:Data>
    </ppx:AddData>
    <ppx:MainBody>
        <ppx:BodyContent xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ppx:FBD">
            <ppx:Network>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="localResultA" globalId="7">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="2"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="490" y="50"/>
                    <ppx:Size x="110" y="20"/>
                    <ppx:ConnectionPointIn>
                        <ppx:RelPosition x="0" y="10"/>
                        <ppx:Connection refConnectionPointOutId="8">
                            <ppx:RelPosition x="470" y="60"/>
                            <ppx:RelPosition x="470" y="70"/>
                        </ppx:Connection>
                    </ppx:ConnectionPointIn>
                </ppx:FbdObject>
                <ppx:FbdObject xsi:type="ppx:Block" typeName="myAdd" globalId="9">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
...
<ppx:RelPosition x="90" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="localResultB" globalId="10">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="3"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="490" y="70"/>
                    <ppx:Size x="110" y="20"/>
                    <ppx:ConnectionPointIn>
                        <ppx:RelPosition x="0" y="10"/>
                        <ppx:Connection refConnectionPointOutId="8">
                            <ppx:RelPosition x="470" y="80"/>
                            <ppx:RelPosition x="470" y="70"/>
                        </ppx:Connection>
                    </ppx:ConnectionPointIn>
                </ppx:FbdObject>
