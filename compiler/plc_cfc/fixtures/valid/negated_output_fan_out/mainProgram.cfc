...
VAR
	myInstance: Toggle;
	localEnable, localB: BOOL;
	localOff, localResult: BOOL;
END_VAR</content>
            </textDeclaration>
        </ppx:Data>
    </ppx:AddData>
    <ppx:MainBody>
        <ppx:BodyContent xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ppx:FBD">
            <ppx:Network>
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="localEnable" globalId="1">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="localB" globalId="3">
                    <ppx:RelPosition x="240" y="200"/>
                    <ppx:Size x="80" y="20"/>
                    <ppx:ConnectionPointOut connectionPointOutId="4">
                        <ppx:RelPosition x="80" y="10"/>
                    </ppx:ConnectionPointOut>
                </ppx:FbdObject>
                <ppx:FbdObject xsi:type="ppx:Block" typeName="Toggle" instanceName="myInstance" globalId="5">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                    ...
                    <ppx:InOutVariables/>
                    <ppx:InputVariables>
                        <ppx:InputVariable parameterName="enable" negated="false">
                    ...
                    <ppx:OutputVariables>
                        <ppx:OutputVariable parameterName="isOn" negated="true">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="localOff" globalId="7">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                ...
                <ppx:FbdObject xsi:type="ppx:Block" typeName="myGate" globalId="8">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="3"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="530" y="160"/>
                    <ppx:Size x="90" y="60"/>
                    <ppx:InOutVariables/>
                    <ppx:InputVariables>
                        <ppx:InputVariable parameterName="a" negated="true">
                            <ppx:ConnectionPointIn>
                                <ppx:RelPosition x="0" y="30"/>
                                <ppx:Connection refConnectionPointOutId="6"/>
                            </ppx:ConnectionPointIn>
                    ...
                    <ppx:OutputVariables>
                        <ppx:OutputVariable parameterName="myGate" negated="false">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSink" identifier="localResult" globalId="10">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
                            <EvaluationPriority priorityInNetwork="4"/>
                        </ppx:Data>
                    </ppx:AddData>
                    <ppx:RelPosition x="660" y="180"/>
                    <ppx:Size x="110" y="20"/>
                    <ppx:ConnectionPointIn>
                        <ppx:RelPosition x="0" y="10"/>
