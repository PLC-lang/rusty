...
newtype_impl!(SDimension, "Dimension", false);
newtype_impl!(SRange, "Range", false);
...
newtype_impl!(SClass, "Class", false);
newtype_impl!(SMethod, "Method", false);
newtype_impl!(SOmronAction, "Action", false);
