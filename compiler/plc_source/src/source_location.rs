...
impl SourceLocationFactory {
    ...
    pub fn create_range(&self, range: core::ops::Range<usize>) -> SourceLocation {
        ...
        SourceLocation {
            span: CodeSpan::Range(start..end),
            file: self.file,
            slice: &self.content[start.offset..end.offset],
        }
    }
    ...
    pub fn create_file_only_location(&self) -> SourceLocation {
        SourceLocation { span: CodeSpan::None, file: self.file, slice: "" }
    }
...
impl SourceLocation {
    ...
    pub fn undefined() -> SourceLocation {
        SourceLocation { span: CodeSpan::None, file: None, slice: "" }
    }
    ...
    pub fn span(&self, other: &SourceLocation) -> SourceLocation {
        ...
        // TODO: This is currently incorrect, the source code is needed here
        SourceLocation { span, file: self.get_file_name(), slice: self.slice }
    }
...
mod tests {
    ...
    fn span_none() {
        ...
        let loc2 = SourceLocation { file: None, span: CodeSpan::None, slice: "" };
        assert_debug_snapshot!(loc1.span(&loc2));
    }
}
