...
impl SourceLocationFactory {
    ...
    pub fn internal(src: &'static str) -> Self {
        SourceLocationFactory { file: None, newlines: NewLines::build(src), source_code: src }
    }
    ...
    pub fn create_range(&self, range: core::ops::Range<usize>) -> SourceLocation {
        ...
        SourceLocation { span: CodeSpan::Range(start..end), file: self.file, slice: &self.source_code[start.offset..end.offset]}
    }
...
impl SourceLocation {
    ...
    pub fn span(&self, other: &SourceLocation) -> SourceLocation {
        ...
        //TODO: Slice does not work when spanning, we need the original text
