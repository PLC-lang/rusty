...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="enable_inout">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM enable_inout
VAR
    trigger : BOOL;
    total : DINT := 10;
    result : DINT;
END_VAR</bmx:TextDeclaration>
    ...
    <ppx:MainBody>
        <ppx:BodyContent xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ppx:FBD">
            <ppx:Network>
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="5" globalId="6">
                    <ppx:RelPosition x="480" y="370"/>
                    <ppx:Size x="80" y="20"/>
                    <ppx:ConnectionPointOut connectionPointOutId="2">
                        <ppx:RelPosition x="80" y="10"/>
                    </ppx:ConnectionPointOut>
                </ppx:FbdObject>
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="total" globalId="7">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="trigger" globalId="9">
                    <ppx:RelPosition x="480" y="330"/>
                    <ppx:Size x="80" y="20"/>
...
<ppx:Connection refConnectionPointOutId="2"/>
                    ...
                    <ppx:InOutVariables>
                        <ppx:InOutVariable parameterName="acc" negated="false">
                            <ppx:ConnectionPointIn>
