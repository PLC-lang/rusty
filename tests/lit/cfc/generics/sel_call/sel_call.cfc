...
<ppx:Program xmlns:bmx="http://www.bachmann.at/xml/PLC" xmlns:ppx="www.iec.ch/public/TC65SC65BWG7TF10" xmlns:rxt="www.iec.ch/public/TC65SC65BWG7TF10/Recommendation" name="sel_call">
    <ppx:AddData>
        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
            <bmx:TextDeclaration>PROGRAM sel_call
VAR
    cond : BOOL;
    in0, in1 : DINT;
    result : DINT;
END_VAR</bmx:TextDeclaration>
    ...
    <ppx:MainBody>
        <ppx:BodyContent xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ppx:FBD">
            <ppx:Network>
                <ppx:FbdObject xsi:type="ppx:Block" typeName="SEL" globalId="1">
                    <ppx:AddData>
                        <ppx:Data name="http://www.bachmann.at/xml/PLC" handleUnknown="implementation">
...
<ppx:RelPosition x="130" y="30"/>
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="cond" globalId="6">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="in0" globalId="7">
                ...
                <ppx:FbdObject xsi:type="ppx:DataSource" identifier="in1" globalId="8">
                    <ppx:RelPosition x="480" y="430"/>
                    <ppx:Size x="80" y="20"/>
