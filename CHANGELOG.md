...
## [1.0.6](https://github.com/PLC-lang/rusty/releases/tag/v1.0.6) - 2026-09-15
...
- Add missing STRING_TO functions to the standard library (1.0.x) (#1904)
- **codegen**: Null-terminate untyped variadic argument lists (1.0.x) (#1888)
- **validation**: Remove VAR_INPUT {ref} warning (E042) (1.0.x) (#1893)
- **stdlib**: Backport the no-panic hardening stack (1.0.x) (#1890)
...
- Emit lifetime markers for lowered call temporaries (#1803) (#1819)
- Ensuring no segfault when c library function returns oversized string (#1794) (#1825)
