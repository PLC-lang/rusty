...
- Warn if an array gets too big (#1665) ([#1665](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Reject direct interface calls (#1666) ([#1666](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Loop desugaring (#1655) ([#1655](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Validation for trailing access on property setter (#1661) ([#1661](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- **validation**: Warn on array initialization with fewer elements than expected (#1645) ([#1645](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Improve the relocation strategies with -fpic and -fno-pic instead of --pic and --no-pic which were not doing what's expected (#1638) ([#1638](https://github.com/PLC-lang/rusty/pull/{{ number }}), [#1619](https://github.com/PLC-lang/rusty/pull/{{ number }}))

### Fixed

- Regression ctors were causing functions not to be debuggable (#1681) ([#1681](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Treat GET and SET as contextual property keywords (#1668) ([#1668](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Add a debug line on REF= statements (#1680) ([#1680](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Updated call lowering to include direct access in call assignment when lowering output assignment (#1657) ([#1657](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Fixed real parsing for 'prettily' formatted numbers (#1672) ([#1672](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- TP timer no longer panics in specific cases (#1667) ([#1667](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Ensuring conditional statements are evaluated correctly (#1669) ([#1669](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Also consider references in array validation (#1660) ([#1660](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Added validation to block constant reference or pointer assignment (#1654) ([#1654](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Ignore noisy E015 POINTER TO warning (#1658) ([#1658](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Resolve itable member type dependencies for Value annotations (#1650) ([#1650](https://github.com/PLC-lang/rusty/pull/{{ number }}), [#1535](https://github.com/PLC-lang/rusty/pull/{{ number }}), [#1649](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Added header generation support for ref_to arrays (#1652) ([#1652](https://github.com/PLC-lang/rusty/pull/{{ number }}))
- Added support for the internal void type in generated headers (#1646) ([#1646](https://github.com/PLC-lang/rusty/pull/{{ number }}))
...
- Hoist allocas on function entry (#1656) ([#1656](https://github.com/PLC-lang/rusty/pull/{{ number }}))
