...
pub enum CompileError {
    ...
    InvalidReference{reference: String, location: core::ops::Range<usize>},
    ...
    CastError{ type_name: String, target_type: String, location: core::ops::Range<usize>}
}

impl CompileError {

    pub fn missing_function(location: Range<usize>) -> CompileError {
        CompileError::MissingFunctionError { location: location.clone() }
    }
