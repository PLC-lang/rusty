...
use crate::{
    ...
    typesystem::{self, is_same_type_class, DataType, DataTypeInformation, DataTypeInformationProvider, Dimension, StringEncoding, VarArgs, DINT_TYPE, INT_SIZE, INT_TYPE, LINT_TYPE},
};
            ...
            | Some(StatementAnnotation::Program { qualified_name, .. }) => self
                ...
                .map_or(
                    self.llvm_index
                        ...
                        .ok_or_else(|| Diagnostic::unresolved_reference(name, offset).into()).into(),
                    Ok,
                ),
