...
fn array_in_parent_generated() {
    ...
    entry:
      ...
      %z = getelementptr inbounds %child, %child* %tmpVar11, i32 0, i32 1
      %tmpVar12 = getelementptr inbounds [11 x i16], [11 x i16]* %z, i32 0, i32 2
      store i16 50, i16* %tmpVar12, align 2
      ret void
    }
...
fn complex_array_access_generated() {
    ...
    entry:
      ...
      %tmpVar = mul i32 %2, 2
      %tmpVar4 = mul i32 1, %tmpVar
      %tmpVar5 = add i32 %tmpVar4, 0
      %tmpVar6 = getelementptr inbounds [11 x i16], [11 x i16]* %z, i32 0, i32 %tmpVar5
      ...
      %tmpVar10 = mul i32 1, %tmpVar9
      %tmpVar11 = add i32 %tmpVar10, 0
      %tmpVar12 = getelementptr inbounds [6 x i16], [6 x i16]* %y, i32 0, i32 %tmpVar11
      store i16 20, i16* %tmpVar12, align 2
      ret void
    }
