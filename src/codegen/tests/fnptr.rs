...
fn function_pointer_method_no_parameters() {
    let result = codegen(
        ...
        FUNCTION main
            VAR
                instanceA: A;
                fnPtr: POINTER TO A.foo := ADR(A.foo);
            END_VAR
    ...
    entry:
      ...
      store void (%A*)* @A__foo, void (%A*)** %fnPtr, align 8
      %1 = load void (%A*)*, void (%A*)** %fnPtr, align 8
...
fn function_pointer_method_with_return_type() {
    ...
    entry:
      %instanceA = alloca %A, align 8
      %fnPtr = alloca i32 (%A*)*, align 8
      %0 = bitcast %A* %instanceA to i8*
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %0, i8* align 1 bitcast (%A* @__A__init to i8*), i64 ptrtoint (%A* getelementptr (%A, %A* null, i32 1) to i64), i1 false)
      store i32 (%A*)* @A__foo, i32 (%A*)** %fnPtr, align 8
      %1 = load i32 (%A*)*, i32 (%A*)** %fnPtr, align 8
...
fn function_pointer_method_with_return_type_aggregate() {
    let result = codegen(
        ...
        FUNCTION main
            VAR
                instanceA: A;
                fnPtr: POINTER TO A.foo := ADR(A.foo);
                fnPtr2: POINTER TO A.bar := ADR(A.bar);
            END_VAR
    ...
    entry:
      %instanceA = alloca %A, align 8
      %fnPtr = alloca void (%A*, [81 x i8]*)*, align 8
      %fnPtr2 = alloca void (%A*, [5 x i32]*)*, align 8
      %0 = bitcast %A* %instanceA to i8*
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %0, i8* align 1 bitcast (%A* @__A__init to i8*), i64 ptrtoint (%A* getelementptr (%A, %A* null, i32 1) to i64), i1 false)
      store void (%A*, [81 x i8]*)* bitcast (void (%A*, i8*)* @A__foo to void (%A*, [81 x i8]*)*), void (%A*, [81 x i8]*)** %fnPtr, align 8
      store void (%A*, [5 x i32]*)* bitcast (void (%A*, i32*)* @A__bar to void (%A*, [5 x i32]*)*), void (%A*, [5 x i32]*)** %fnPtr2, align 8
      ...
      %2 = load void (%A*, [81 x i8]*)*, void (%A*, [81 x i8]*)** %fnPtr, align 8
      ...
      %5 = load void (%A*, [5 x i32]*)*, void (%A*, [5 x i32]*)** %fnPtr2, align 8
...
fn function_pointer_method_with_all_variable_parameter_types() {
    let result = codegen(
        ...
        FUNCTION main
            ...
            // fnPtr^(instanceA, localIn, localOut, localInOut);
            fnPtr^(instanceA, out => localOut, inout := localInOut, in := localIn); // Arguments shifted by one to the right
        END_FUNCTION
        ",
    );
    ...
    entry:
      %instanceA = alloca %A, align 8
      %fnPtr = alloca i32 (%A*, i32, [81 x i8]*, [5 x i32]*)*, align 8
      %localIn = alloca i32, align 4
      %localOut = alloca [81 x i8], align 1
      %localInOut = alloca [5 x i32], align 4
      %0 = bitcast %A* %instanceA to i8*
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %0, i8* align 1 bitcast (%A* @__A__init to i8*), i64 ptrtoint (%A* getelementptr (%A, %A* null, i32 1) to i64), i1 false)
      store i32 (%A*, i32, [81 x i8]*, [5 x i32]*)* bitcast (i32 (%A*, i32, [81 x i8]*, i32*)* @A__foo to i32 (%A*, i32, [81 x i8]*, [5 x i32]*)*), i32 (%A*, i32, [81 x i8]*, [5 x i32]*)** %fnPtr, align 8
      ...
      %3 = load i32 (%A*, i32, [81 x i8]*, [5 x i32]*)*, i32 (%A*, i32, [81 x i8]*, [5 x i32]*)** %fnPtr, align 8
