...
fn switch_case_debug_info() {
    ...
    continue:                                         ; preds = %condition_body, %condition_check
      %main_ret = load i32, i32* %main, align 4, !dbg !18
    ...
    continue1:                                        ; preds = %buffer_block, %while_body
      %load_x1 = load i16, i16* %x1, align 2, !dbg !20
      %0 = sext i16 %load_x1 to i32, !dbg !20
      %tmpVar = add i32 %0, 1, !dbg !20
      %1 = trunc i32 %tmpVar to i16, !dbg !20
      store i16 %1, i16* %x1, align 2, !dbg !20
      %load_x13 = load i16, i16* %x1, align 2, !dbg !20
    ...
    case:                                             ; preds = %continue1
      store i16 1, i16* %x2, align 2, !dbg !21
      br label %continue2, !dbg !21

    case4:                                            ; preds = %continue1
      store i16 2, i16* %x2, align 2, !dbg !22
      br label %continue2, !dbg !22

    case5:                                            ; preds = %continue1
      store i16 3, i16* %x2, align 2, !dbg !23
      br label %continue2, !dbg !23

    else:                                             ; preds = %continue1
      store i16 0, i16* %x1, align 2, !dbg !24
      store i16 1, i16* %x2, align 2, !dbg !25
      store i16 2, i16* %x3, align 2, !dbg !26
    ...
    !18 = !DILocation(line: 12, column: 17, scope: !4)
    !19 = !DILocation(line: 9, column: 18, scope: !4)
    !20 = !DILocation(line: 10, column: 12, scope: !4)
    !21 = !DILocation(line: 13, column: 19, scope: !4)
    !22 = !DILocation(line: 14, column: 19, scope: !4)
    !23 = !DILocation(line: 15, column: 19, scope: !4)
    !24 = !DILocation(line: 17, column: 20, scope: !4)
    !25 = !DILocation(line: 18, column: 20, scope: !4)
    !26 = !DILocation(line: 19, column: 20, scope: !4)
    "###);
}
...
fn action_with_var_temp() {
    ...
    !22 = !DILocalVariable(name: "x", scope: !17, file: !2, line: 9, type: !13, align: 32)
    ...
    !27 = !DILocalVariable(name: "x", scope: !24, file: !2, line: 9, type: !13, align: 32)
