...
fn members_from_base_class_are_available_in_subclasses() {
    ...
    entry:
      ...
      store ptr @foo, ptr %__body, align [filtered], !dbg !35
      ret void, !dbg !35
    }
    ...
    entry:
      ...
      store ptr @bar, ptr %__body, align [filtered], !dbg !35
      ret void, !dbg !35
    }
    ...
    entry:
      ...
      call void @foo_ctor(ptr %__foo), !dbg !35
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !35
      %__foo2 = getelementptr inbounds nuw %bar, ptr %deref1, i32 0, i32 0, !dbg !35
      call void @foo_ctor(ptr %__foo2), !dbg !35
    ...
    entry:
      call void @__vtable_foo_ctor(ptr @__vtable_foo_instance), !dbg !35
      call void @__vtable_bar_ctor(ptr @__vtable_bar_instance), !dbg !35
      ret void, !dbg !35
    }
...
fn write_to_parent_variable_qualified_access() {
    ...
    entry:
      ...
      store ptr @fb, ptr %__body, align [filtered], !dbg !38
      ret void, !dbg !38
    }
    ...
    entry:
      ...
      store ptr @fb2, ptr %__body, align [filtered], !dbg !38
      ret void, !dbg !38
    }
    ...
    entry:
      ...
      store ptr @foo, ptr %__body, align [filtered], !dbg !38
      ret void, !dbg !38
    }
    ...
    entry:
      ...
      call void @__fb___vtable_ctor(ptr %__vtable), !dbg !38
    ...
    entry:
      ...
      call void @fb_ctor(ptr %__fb), !dbg !38
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !38
      %__fb2 = getelementptr inbounds nuw %fb2, ptr %deref1, i32 0, i32 0, !dbg !38
      call void @fb_ctor(ptr %__fb2), !dbg !38
    ...
    entry:
      ...
      call void @__foo___vtable_ctor(ptr %__vtable), !dbg !38
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !38
      %myFb = getelementptr inbounds nuw %foo, ptr %deref1, i32 0, i32 1, !dbg !38
      call void @fb2_ctor(ptr %myFb), !dbg !38
    ...
    define void @__unit___internal___ctor() {
    entry:
      call void @__vtable_fb_ctor(ptr @__vtable_fb_instance), !dbg !38
      call void @__vtable_fb2_ctor(ptr @__vtable_fb2_instance), !dbg !38
      call void @__vtable_foo_ctor(ptr @__vtable_foo_instance), !dbg !38
      ret void, !dbg !38
    }
...
fn write_to_parent_variable_in_instance() {
    ...
    entry:
      ...
      call void @bar_ctor(ptr %fb), !dbg !42
    ...
    entry:
      ...
      store ptr @foo, ptr %__body, align [filtered], !dbg !45
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !45
      %baz = getelementptr inbounds nuw %__vtable_foo, ptr %deref1, i32 0, i32 1, !dbg !45
      store ptr @foo__baz, ptr %baz, align [filtered], !dbg !45
      ret void, !dbg !45
    }
    ...
    entry:
      ...
      store ptr @bar, ptr %__body, align [filtered], !dbg !45
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !45
      %baz = getelementptr inbounds nuw %__vtable_bar, ptr %deref1, i32 0, i32 1, !dbg !45
      store ptr @foo__baz, ptr %baz, align [filtered], !dbg !45
      ret void, !dbg !45
    }
    ...
    entry:
      ...
      call void @__foo___vtable_ctor(ptr %__vtable), !dbg !45
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !45
    ...
    entry:
      ...
      call void @foo_ctor(ptr %__foo), !dbg !45
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !45
      %__foo2 = getelementptr inbounds nuw %bar, ptr %deref1, i32 0, i32 0, !dbg !45
      call void @foo_ctor(ptr %__foo2), !dbg !45
    ...
    define void @__unit___internal___ctor() {
    entry:
      call void @__vtable_foo_ctor(ptr @__vtable_foo_instance), !dbg !45
      call void @__vtable_bar_ctor(ptr @__vtable_bar_instance), !dbg !45
      ret void, !dbg !45
    }
...
fn array_in_parent_generated() {
    ...
    entry:
      ...
      call void @__main_arr_ctor(ptr %arr), !dbg !50
    ...
    entry:
      ...
      store ptr @grandparent, ptr %__body, align [filtered], !dbg !56
      ret void, !dbg !56
    }
    ...
    entry:
      ...
      store ptr @parent, ptr %__body, align [filtered], !dbg !56
      ret void, !dbg !56
    }
    ...
    entry:
      ...
      store ptr @child, ptr %__body, align [filtered], !dbg !56
      ret void, !dbg !56
    }
    ...
    define void @__unit___internal___ctor() {
    entry:
      call void @__vtable_grandparent_ctor(ptr @__vtable_grandparent_instance), !dbg !56
      call void @__vtable_parent_ctor(ptr @__vtable_parent_instance), !dbg !56
      call void @__vtable_child_ctor(ptr @__vtable_child_instance), !dbg !56
      ret void, !dbg !56
    }
...
fn complex_array_access_generated() {
    ...
    entry:
      ...
      store ptr @grandparent, ptr %__body, align [filtered], !dbg !44
      ret void, !dbg !44
    }
    ...
    entry:
      ...
      store ptr @parent, ptr %__body, align [filtered], !dbg !44
      ret void, !dbg !44
    }
    ...
    entry:
      ...
      store ptr @child, ptr %__body, align [filtered], !dbg !44
      ret void, !dbg !44
    }
    ...
    define void @__unit___internal___ctor() {
    entry:
      call void @__vtable_grandparent_ctor(ptr @__vtable_grandparent_instance), !dbg !44
      call void @__vtable_parent_ctor(ptr @__vtable_parent_instance), !dbg !44
      call void @__vtable_child_ctor(ptr @__vtable_child_instance), !dbg !44
      ret void, !dbg !44
    }
...
fn function_block_method_debug_info() {
    ...
    entry:
      ...
      store ptr @foo, ptr %__body, align [filtered], !dbg !26
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !26
      %baz = getelementptr inbounds nuw %__vtable_foo, ptr %deref1, i32 0, i32 1, !dbg !26
      store ptr @foo__baz, ptr %baz, align [filtered], !dbg !26
      ret void, !dbg !26
    }
    ...
    entry:
      ...
      store ptr @bar, ptr %__body, align [filtered], !dbg !26
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !26
      %baz = getelementptr inbounds nuw %__vtable_bar, ptr %deref1, i32 0, i32 1, !dbg !26
      store ptr @foo__baz, ptr %baz, align [filtered], !dbg !26
      ret void, !dbg !26
    }
    ...
    entry:
      ...
      call void @__foo___vtable_ctor(ptr %__vtable), !dbg !26
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !26
    ...
    entry:
      ...
      call void @foo_ctor(ptr %__foo), !dbg !26
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !26
      %__foo2 = getelementptr inbounds nuw %bar, ptr %deref1, i32 0, i32 0, !dbg !26
      call void @foo_ctor(ptr %__foo2), !dbg !26
    ...
    define void @__unit___internal___ctor() {
    entry:
      call void @__vtable_foo_ctor(ptr @__vtable_foo_instance), !dbg !26
      call void @__vtable_bar_ctor(ptr @__vtable_bar_instance), !dbg !26
      ret void, !dbg !26
    }
...
",
    ...
    entry:
      ...
      call void @__main_array_of_parent_ctor(ptr %array_of_parent), !dbg !58
      call void @__main_array_of_child_ctor(ptr %array_of_child), !dbg !58
      call void @__main_array_of_grandchild_ctor(ptr %array_of_grandchild), !dbg !58
      call void @parent_ctor(ptr %parent1), !dbg !58
      call void @child_ctor(ptr %child1), !dbg !58
      call void @grandchild_ctor(ptr %grandchild1), !dbg !58
    ...
    define void @__main_array_of_parent_ctor(ptr %0) {
    entry:
    ...
    define void @__main_array_of_child_ctor(ptr %0) {
    entry:
      %self = alloca ptr, align [filtered], !dbg !83
      store ptr %0, ptr %self, align [filtered], !dbg !83
      ret void, !dbg !83
    ...
    define void @__main_array_of_grandchild_ctor(ptr %0) {
    entry:
      %self = alloca ptr, align [filtered], !dbg !83
      store ptr %0, ptr %self, align [filtered], !dbg !83
      ret void, !dbg !83
    ...
    entry:
      ...
      store ptr @parent, ptr %__body, align [filtered], !dbg !83
      ret void, !dbg !83
    }
    ...
    entry:
      ...
      store ptr @child, ptr %__body, align [filtered], !dbg !83
      ret void, !dbg !83
    }

    define void @__vtable_grandchild_ctor(ptr %0) {
    entry:
      %self = alloca ptr, align [filtered], !dbg !83
      store ptr %0, ptr %self, align [filtered], !dbg !83
      %deref = load ptr, ptr %self, align [filtered], !dbg !83
      %__body = getelementptr inbounds nuw %__vtable_grandchild, ptr %deref, i32 0, i32 0, !dbg !83
      store ptr @grandchild, ptr %__body, align [filtered], !dbg !83
      ret void, !dbg !83
    }

    define void @__parent___vtable_ctor(ptr %0) {
    entry:
      %self = alloca ptr, align [filtered], !dbg !83
      store ptr %0, ptr %self, align [filtered], !dbg !83
      ret void, !dbg !83
    ...
    define void @____vtable_grandchild___body_ctor(ptr %0) {
    entry:
      %self = alloca ptr, align [filtered], !dbg !83
      store ptr %0, ptr %self, align [filtered], !dbg !83
      ret void, !dbg !83
    ...
    entry:
      ...
      call void @__parent___vtable_ctor(ptr %__vtable), !dbg !83
    ...
    entry:
      ...
      call void @parent_ctor(ptr %__parent), !dbg !83
      %deref1 = load ptr, ptr %self, align [filtered], !dbg !83
      %__parent2 = getelementptr inbounds nuw %child, ptr %deref1, i32 0, i32 0, !dbg !83
      call void @parent_ctor(ptr %__parent2), !dbg !83
    ...
    define void @__unit___internal___ctor() {
    entry:
      call void @__vtable_parent_ctor(ptr @__vtable_parent_instance), !dbg !83
      call void @__vtable_child_ctor(ptr @__vtable_child_instance), !dbg !83
      call void @__vtable_grandchild_ctor(ptr @__vtable_grandchild_instance), !dbg !83
      ret void, !dbg !83
    }
