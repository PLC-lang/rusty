...
fn write_to_parent_variable_qualified_access() {
    ...
    entry:
      ...
      store i16 1, ptr %x, align [filtered], !dbg !47
      ret void, !dbg !48
    }
...
fn write_to_parent_variable_in_instance() {
    ...
    entry:
      ...
      %__vtable = getelementptr inbounds nuw %foo, ptr %0, i32 0, i32 0
      %s = getelementptr inbounds nuw %foo, ptr %0, i32 0, i32 1
      call void @llvm.memcpy.p0.p0.i32(ptr align [filtered] %s, ptr align [filtered] @utf08_literal_0, i32 6, i1 false), !dbg !34
      ret void, !dbg !35
    }
    ...
    entry:
      ...
      call void @llvm.memcpy.p0.p0.i32(ptr align [filtered] %s, ptr align [filtered] @utf08_literal_1, i32 6, i1 false), !dbg !40
      ret void, !dbg !41
    }
...
fn array_in_parent_generated() {
    ...
    entry:
      ...
      store i16 10, ptr %a, align [filtered], !dbg !60
      ...
      store i16 20, ptr %tmpVar4, align [filtered], !dbg !61
      ...
      store i16 30, ptr %b, align [filtered], !dbg !62
      ...
      store i16 40, ptr %tmpVar9, align [filtered], !dbg !63
      ...
      store i16 50, ptr %tmpVar11, align [filtered], !dbg !64
      ret void, !dbg !65
    }
...
fn complex_array_access_generated() {
    ...
    entry:
      ...
      %load_tmpVar = load i16, ptr %tmpVar5, align [filtered], !dbg !53
      ...
      %load_a = load i16, ptr %a, align [filtered], !dbg !53
      ...
      store i16 20, ptr %tmpVar11, align [filtered], !dbg !53
      ret void, !dbg !54
    }
...
",
    ...
    entry:
      ...
      store i32 1, ptr %a, align [filtered], !dbg !69
      ...
      store i32 2, ptr %a1, align [filtered], !dbg !70
      %b = getelementptr inbounds nuw %child, ptr %child1, i32 0, i32 1, !dbg !71
      store i32 3, ptr %b, align [filtered], !dbg !71
      ...
      store i32 4, ptr %a3, align [filtered], !dbg !72
      ...
      store i32 5, ptr %b5, align [filtered], !dbg !73
      ...
      store i32 7, ptr %a6, align [filtered], !dbg !75
      ...
      store i32 8, ptr %a9, align [filtered], !dbg !76
      ...
      store i32 9, ptr %b11, align [filtered], !dbg !77
      ...
      store i32 10, ptr %a15, align [filtered], !dbg !78
      ...
      store i32 11, ptr %b18, align [filtered], !dbg !79
      ...
      store i32 12, ptr %c20, align [filtered], !dbg !80
      ...
      store i32 13, ptr %a22, align [filtered], !dbg !81
      ...
      store i32 14, ptr %a25, align [filtered], !dbg !82
      ...
      store i32 15, ptr %b27, align [filtered], !dbg !83
      ...
      store i32 16, ptr %a31, align [filtered], !dbg !84
      ...
      store i32 17, ptr %b34, align [filtered], !dbg !85
      ...
      store i32 18, ptr %c36, align [filtered], !dbg !86
      ...
      store i32 19, ptr %a38, align [filtered], !dbg !87
      ...
      store i32 20, ptr %a41, align [filtered], !dbg !88
      ...
      store i32 21, ptr %b43, align [filtered], !dbg !89
      ...
      store i32 22, ptr %a47, align [filtered], !dbg !90
      ...
      store i32 23, ptr %b50, align [filtered], !dbg !91
      ...
      store i32 24, ptr %c52, align [filtered], !dbg !92
      %main_ret = load i32, ptr %main, align [filtered], !dbg !93
