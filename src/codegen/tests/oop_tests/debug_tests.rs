...
fn members_from_base_class_are_available_in_subclasses() {
    ...
    entry:
      ...
      %deref = load %__vtable_foo*, %__vtable_foo** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_foo, %__vtable_foo* %deref, i32 0, i32 0
      store void (%foo*)* @foo, void (%foo*)** %__body, align [filtered]
      ret void
    }

    define void @__init___vtable_bar(%__vtable_bar* %0) {
    entry:
      %self = alloca %__vtable_bar*, align [filtered]
      store %__vtable_bar* %0, %__vtable_bar** %self, align [filtered]
      %deref = load %__vtable_bar*, %__vtable_bar** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_bar, %__vtable_bar* %deref, i32 0, i32 0
      store void (%bar*)* @bar, void (%bar*)** %__body, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      %deref = load %foo*, %foo** %self, align [filtered]
      %__vtable = getelementptr inbounds %foo, %foo* %deref, i32 0, i32 0
      store i32* bitcast (%__vtable_foo* @__vtable_foo_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }

    define void @__init_bar(%bar* %0) {
    entry:
      %self = alloca %bar*, align [filtered]
      store %bar* %0, %bar** %self, align [filtered]
      %deref = load %bar*, %bar** %self, align [filtered]
      %__foo = getelementptr inbounds %bar, %bar* %deref, i32 0, i32 0
      call void @__init_foo(%foo* %__foo)
      %deref1 = load %bar*, %bar** %self, align [filtered]
      %__foo2 = getelementptr inbounds %bar, %bar* %deref1, i32 0, i32 0
      %__vtable = getelementptr inbounds %foo, %foo* %__foo2, i32 0, i32 0
      store i32* bitcast (%__vtable_bar* @__vtable_bar_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }
    ...
    !7 = !DIDerivedType(tag: DW_TAG_typedef, name: "__POINTER_TO____foo___vtable", scope: !2, file: !2, baseType: !8, align [filtered])
    !8 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__foo___vtable", baseType: !9, size: 64, align [filtered], dwarfAddressSpace: 1)
    !9 = !DIBasicType(name: "__VOID", encoding: DW_ATE_unsigned, flags: DIFlagPublic)
    !10 = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: !2, file: !2, line: 4, baseType: !11, size: 16, align [filtered], offset: 64, flags: DIFlagPublic)
    !11 = !DIBasicType(name: "INT", size: 16, encoding: DW_ATE_signed, flags: DIFlagPublic)
    !12 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !2, file: !2, line: 5, baseType: !13, size: 648, align [filtered], offset: 80, flags: DIFlagPublic)
    !13 = !DIDerivedType(tag: DW_TAG_typedef, name: "__STRING__81", scope: !2, file: !2, baseType: !14, align [filtered])
    !14 = !DICompositeType(tag: DW_TAG_array_type, baseType: !15, size: 648, align [filtered], elements: !16)
    !15 = !DIBasicType(name: "CHAR", size: 8, encoding: DW_ATE_UTF, flags: DIFlagPublic)
    !16 = !{!17}
    !17 = !DISubrange(count: 81, lowerBound: 0)
    !18 = !DIDerivedType(tag: DW_TAG_member, name: "c", scope: !2, file: !2, line: 6, baseType: !19, size: 7128, align [filtered], offset: 728, flags: DIFlagPublic)
    !19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 7128, align [filtered], elements: !20)
    !20 = !{!21}
    ...
    !25 = !DICompositeType(tag: DW_TAG_structure_type, name: "bar", scope: !2, file: !2, line: 10, size: 7872, align [filtered], flags: DIFlagPublic, elements: !26, identifier: "bar")
    !26 = !{!27}
    !27 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !4, size: 7872, align [filtered], flags: DIFlagPublic)
...
fn write_to_parent_variable_qualified_access() {
    ...
    entry:
      ...
      %this = alloca %fb2*, align [filtered]
      store %fb2* %0, %fb2** %this, align [filtered]
    ...
    entry:
      ...
      store i16 1, i16* %x, align [filtered], !dbg !47
      ret void, !dbg !48
    }
    ...
    entry:
      %self = alloca %__vtable_fb2*, align [filtered]
      store %__vtable_fb2* %0, %__vtable_fb2** %self, align [filtered]
      %deref = load %__vtable_fb2*, %__vtable_fb2** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_fb2, %__vtable_fb2* %deref, i32 0, i32 0
      store void (%fb2*)* @fb2, void (%fb2*)** %__body, align [filtered]
      ret void
    }
    ...
    entry:
      %self = alloca %fb2*, align [filtered]
      store %fb2* %0, %fb2** %self, align [filtered]
      %deref = load %fb2*, %fb2** %self, align [filtered]
      %__fb = getelementptr inbounds %fb2, %fb2* %deref, i32 0, i32 0
      call void @__init_fb(%fb* %__fb)
      %deref1 = load %fb2*, %fb2** %self, align [filtered]
      %__fb2 = getelementptr inbounds %fb2, %fb2* %deref1, i32 0, i32 0
      %__vtable = getelementptr inbounds %fb, %fb* %__fb2, i32 0, i32 0
      store i32* bitcast (%__vtable_fb2* @__vtable_fb2_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      %deref1 = load %foo*, %foo** %self, align [filtered]
    ...
    !2 = !DIFile(filename: "<internal>", directory: "")
    !3 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !4)
    !4 = !DICompositeType(tag: DW_TAG_structure_type, name: "fb", scope: !2, file: !2, line: 2, size: 128, align [filtered], flags: DIFlagPublic, elements: !5, identifier: "fb")
    !5 = !{!6, !10, !12}
    !6 = !DIDerivedType(tag: DW_TAG_member, name: "__vtable", scope: !2, file: !2, baseType: !7, size: 64, align [filtered], flags: DIFlagPublic)
    ...
    !9 = !DIBasicType(name: "__VOID", encoding: DW_ATE_unsigned, flags: DIFlagPublic)
    !10 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !2, file: !2, line: 4, baseType: !11, size: 16, align [filtered], offset: 64, flags: DIFlagPublic)
    !11 = !DIBasicType(name: "INT", size: 16, encoding: DW_ATE_signed, flags: DIFlagPublic)
    !12 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !2, file: !2, line: 5, baseType: !11, size: 16, align [filtered], offset: 80, flags: DIFlagPublic)
    ...
    !16 = !DICompositeType(tag: DW_TAG_structure_type, name: "fb2", scope: !2, file: !2, line: 9, size: 128, align [filtered], flags: DIFlagPublic, elements: !17, identifier: "fb2")
    !17 = !{!18}
    !18 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !4, size: 128, align [filtered], flags: DIFlagPublic)
    ...
    !23 = !{!24, !27}
    !24 = !DIDerivedType(tag: DW_TAG_member, name: "__vtable", scope: !2, file: !2, baseType: !25, size: 64, align [filtered], flags: DIFlagPublic)
    !25 = !DIDerivedType(tag: DW_TAG_typedef, name: "__POINTER_TO____foo___vtable", scope: !2, file: !2, baseType: !26, align [filtered])
    !26 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__foo___vtable", baseType: !9, size: 64, align [filtered], dwarfAddressSpace: 1)
    !27 = !DIDerivedType(tag: DW_TAG_member, name: "myFb", scope: !2, file: !2, line: 14, baseType: !16, size: 128, align [filtered], offset: 64, flags: DIFlagPublic)
    !28 = !{i32 2, !"Dwarf Version", i32 5}
    !29 = !{i32 2, !"Debug Info Version", i32 3}
    !30 = distinct !DICompileUnit(language: DW_LANG_C, file: !2, producer: "RuSTy Structured text Compiler", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !31, splitDebugInlining: false)
    !31 = !{!0, !13, !19}
...
fn write_to_parent_variable_in_instance() {
    ...
    entry:
      ...
      call void @llvm.memcpy.p0i8.p0i8.i32(i8* align [filtered] %1, i8* align [filtered] getelementptr inbounds ([6 x i8], [6 x i8]* @utf08_literal_0, i32 0, i32 0), i32 6, i1 false), !dbg !34
      ret void, !dbg !35
    }
    ...
    entry:
      ...
      call void @llvm.memcpy.p0i8.p0i8.i32(i8* align [filtered] %1, i8* align [filtered] getelementptr inbounds ([6 x i8], [6 x i8]* @utf08_literal_1, i32 0, i32 0), i32 6, i1 false), !dbg !40
      ret void, !dbg !41
    }
    ...
    entry:
      ...
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %1, i8* align [filtered] bitcast (%bar* @__bar__init to i8*), i64 ptrtoint (%bar* getelementptr (%bar, %bar* null, i32 1) to i64), i1 false)
    ...
    entry:
      ...
      %__body = getelementptr inbounds %__vtable_foo, %__vtable_foo* %deref, i32 0, i32 0
      store void (%foo*)* @foo, void (%foo*)** %__body, align [filtered]
      %deref1 = load %__vtable_foo*, %__vtable_foo** %self, align [filtered]
      %baz = getelementptr inbounds %__vtable_foo, %__vtable_foo* %deref1, i32 0, i32 1
      store void (%foo*)* @foo__baz, void (%foo*)** %baz, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      %__body = getelementptr inbounds %__vtable_bar, %__vtable_bar* %deref, i32 0, i32 0
      store void (%bar*)* @bar, void (%bar*)** %__body, align [filtered]
      %deref1 = load %__vtable_bar*, %__vtable_bar** %self, align [filtered]
    ...
    !8 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__foo___vtable", baseType: !9, size: 64, align [filtered], dwarfAddressSpace: 1)
    !9 = !DIBasicType(name: "__VOID", encoding: DW_ATE_unsigned, flags: DIFlagPublic)
    !10 = !DIDerivedType(tag: DW_TAG_member, name: "s", scope: !2, file: !2, line: 4, baseType: !11, size: 648, align [filtered], offset: 64, flags: DIFlagPublic)
    !11 = !DIDerivedType(tag: DW_TAG_typedef, name: "__STRING__81", scope: !2, file: !2, baseType: !12, align [filtered])
    !12 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 648, align [filtered], elements: !14)
    ...
    !19 = !DICompositeType(tag: DW_TAG_structure_type, name: "bar", scope: !2, file: !2, line: 11, size: 768, align [filtered], flags: DIFlagPublic, elements: !20, identifier: "bar")
    !20 = !{!21}
    !21 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !4, size: 768, align [filtered], flags: DIFlagPublic)
    ...
    !44 = !{null}
    !45 = !DILocalVariable(name: "s", scope: !42, file: !2, line: 17, type: !11, align [filtered])
    !46 = !DILocation(line: 17, column: 12, scope: !42)
    !47 = !DILocalVariable(name: "fb", scope: !42, file: !2, line: 18, type: !19, align [filtered])
...
fn array_in_parent_generated() {
    ...
    entry:
      ...
      %this = alloca %grandparent*, align [filtered]
      store %grandparent* %0, %grandparent** %this, align [filtered]
    ...
    entry:
      ...
      %this = alloca %parent*, align [filtered]
      store %parent* %0, %parent** %this, align [filtered]
    ...
    entry:
      ...
      %this = alloca %child*, align [filtered]
      store %child* %0, %child** %this, align [filtered]
    ...
    entry:
      ...
      call void @llvm.memset.p0i8.i64(i8* align [filtered] %0, i8 0, i64 ptrtoint ([11 x %child]* getelementptr ([11 x %child], [11 x %child]* null, i32 1) to i64), i1 false)
      ...
      store i16 10, i16* %a, align [filtered], !dbg !60
      ...
      store i16 20, i16* %tmpVar4, align [filtered], !dbg !61
      ...
      store i16 30, i16* %b, align [filtered], !dbg !62
      ...
      store i16 40, i16* %tmpVar9, align [filtered], !dbg !63
      ...
      store i16 50, i16* %tmpVar11, align [filtered], !dbg !64
      ret void, !dbg !65
    }
    ...
    entry:
      %self = alloca %__vtable_grandparent*, align [filtered]
      store %__vtable_grandparent* %0, %__vtable_grandparent** %self, align [filtered]
      %deref = load %__vtable_grandparent*, %__vtable_grandparent** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_grandparent, %__vtable_grandparent* %deref, i32 0, i32 0
      store void (%grandparent*)* @grandparent, void (%grandparent*)** %__body, align [filtered]
      ret void
    }

    define void @__init___vtable_parent(%__vtable_parent* %0) {
    entry:
      %self = alloca %__vtable_parent*, align [filtered]
      store %__vtable_parent* %0, %__vtable_parent** %self, align [filtered]
      %deref = load %__vtable_parent*, %__vtable_parent** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_parent, %__vtable_parent* %deref, i32 0, i32 0
      store void (%parent*)* @parent, void (%parent*)** %__body, align [filtered]
      ret void
    }

    define void @__init___vtable_child(%__vtable_child* %0) {
    entry:
      %self = alloca %__vtable_child*, align [filtered]
      store %__vtable_child* %0, %__vtable_child** %self, align [filtered]
      %deref = load %__vtable_child*, %__vtable_child** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_child, %__vtable_child* %deref, i32 0, i32 0
      store void (%child*)* @child, void (%child*)** %__body, align [filtered]
      ret void
    }

    define void @__init_child(%child* %0) {
    entry:
      %self = alloca %child*, align [filtered]
      store %child* %0, %child** %self, align [filtered]
      %deref = load %child*, %child** %self, align [filtered]
      %__parent = getelementptr inbounds %child, %child* %deref, i32 0, i32 0
      call void @__init_parent(%parent* %__parent)
      %deref1 = load %child*, %child** %self, align [filtered]
      ...
      store i32* bitcast (%__vtable_child* @__vtable_child_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }

    define void @__init_parent(%parent* %0) {
    entry:
      %self = alloca %parent*, align [filtered]
      store %parent* %0, %parent** %self, align [filtered]
      %deref = load %parent*, %parent** %self, align [filtered]
      ...
      %deref1 = load %parent*, %parent** %self, align [filtered]
      ...
      store i32* bitcast (%__vtable_parent* @__vtable_parent_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }

    define void @__init_grandparent(%grandparent* %0) {
    entry:
      %self = alloca %grandparent*, align [filtered]
      store %grandparent* %0, %grandparent** %self, align [filtered]
      %deref = load %grandparent*, %grandparent** %self, align [filtered]
      %__vtable = getelementptr inbounds %grandparent, %grandparent* %deref, i32 0, i32 0
      store i32* bitcast (%__vtable_grandparent* @__vtable_grandparent_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }
    ...
    !2 = !DIFile(filename: "<internal>", directory: "")
    !3 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !4)
    !4 = !DICompositeType(tag: DW_TAG_structure_type, name: "grandparent", scope: !2, file: !2, line: 2, size: 192, align [filtered], flags: DIFlagPublic, elements: !5, identifier: "grandparent")
    !5 = !{!6, !10, !15}
    !6 = !DIDerivedType(tag: DW_TAG_member, name: "__vtable", scope: !2, file: !2, baseType: !7, size: 64, align [filtered], flags: DIFlagPublic)
    !7 = !DIDerivedType(tag: DW_TAG_typedef, name: "__POINTER_TO____grandparent___vtable", scope: !2, file: !2, baseType: !8, align [filtered])
    !8 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__grandparent___vtable", baseType: !9, size: 64, align [filtered], dwarfAddressSpace: 1)
    !9 = !DIBasicType(name: "__VOID", encoding: DW_ATE_unsigned, flags: DIFlagPublic)
    !10 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !2, file: !2, line: 4, baseType: !11, size: 96, align [filtered], offset: 64, flags: DIFlagPublic)
    !11 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 96, align [filtered], elements: !13)
    !12 = !DIBasicType(name: "INT", size: 16, encoding: DW_ATE_signed, flags: DIFlagPublic)
    !13 = !{!14}
    !14 = !DISubrange(count: 6, lowerBound: 0)
    !15 = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: !2, file: !2, line: 5, baseType: !12, size: 16, align [filtered], offset: 160, flags: DIFlagPublic)
    !16 = !DIGlobalVariableExpression(var: !17, expr: !DIExpression())
    !17 = distinct !DIGlobalVariable(name: "__parent__init", scope: !2, file: !2, line: 9, type: !18, isLocal: false, isDefinition: true)
    !18 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !19)
    !19 = !DICompositeType(tag: DW_TAG_structure_type, name: "parent", scope: !2, file: !2, line: 9, size: 384, align [filtered], flags: DIFlagPublic, elements: !20, identifier: "parent")
    !20 = !{!21, !22, !26}
    !21 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !4, size: 192, align [filtered], flags: DIFlagPublic)
    !22 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !2, file: !2, line: 11, baseType: !23, size: 176, align [filtered], offset: 192, flags: DIFlagPublic)
    !23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 176, align [filtered], elements: !24)
    !24 = !{!25}
    !25 = !DISubrange(count: 11, lowerBound: 0)
    !26 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !2, file: !2, line: 12, baseType: !12, size: 16, align [filtered], offset: 368, flags: DIFlagPublic)
    ...
    !30 = !DICompositeType(tag: DW_TAG_structure_type, name: "child", scope: !2, file: !2, line: 16, size: 576, align [filtered], flags: DIFlagPublic, elements: !31, identifier: "child")
    !31 = !{!32, !33}
    !32 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !19, size: 384, align [filtered], flags: DIFlagPublic)
    !33 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !2, file: !2, line: 18, baseType: !23, size: 176, align [filtered], offset: 384, flags: DIFlagPublic)
    ...
    !56 = !{null}
    !57 = !DILocalVariable(name: "arr", scope: !54, file: !2, line: 24, type: !58, align [filtered])
    !58 = !DICompositeType(tag: DW_TAG_array_type, baseType: !30, size: 6336, align [filtered], elements: !24)
...
fn complex_array_access_generated() {
    ...
    entry:
      ...
      %load_tmpVar = load i16, i16* %tmpVar5, align [filtered], !dbg !53
      ...
      %load_a = load i16, i16* %a, align [filtered], !dbg !53
      ...
      store i16 20, i16* %tmpVar11, align [filtered], !dbg !53
      ret void, !dbg !54
    }
...
fn function_block_method_debug_info() {
    ...
    !13 = !DICompositeType(tag: DW_TAG_structure_type, name: "bar", scope: !2, file: !2, line: 7, size: 64, align [filtered], flags: DIFlagPublic, elements: !14, identifier: "bar")
    !14 = !{!15}
    !15 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !4, size: 64, align [filtered], flags: DIFlagPublic)
...
",
    ...
    entry:
      ...
      %this = alloca %grandchild*, align [filtered]
      store %grandchild* %0, %grandchild** %this, align [filtered]
    ...
    entry:
      ...
      call void @llvm.memset.p0i8.i64(i8* align [filtered] %0, i8 0, i64 ptrtoint ([3 x %parent]* getelementptr ([3 x %parent], [3 x %parent]* null, i32 1) to i64), i1 false)
      ...
      call void @llvm.memset.p0i8.i64(i8* align [filtered] %1, i8 0, i64 ptrtoint ([3 x %child]* getelementptr ([3 x %child], [3 x %child]* null, i32 1) to i64), i1 false)
      ...
      call void @llvm.memset.p0i8.i64(i8* align [filtered] %2, i8 0, i64 ptrtoint ([3 x %grandchild]* getelementptr ([3 x %grandchild], [3 x %grandchild]* null, i32 1) to i64), i1 false)
      ...
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %3, i8* align [filtered] bitcast (%parent* @__parent__init to i8*), i64 ptrtoint (%parent* getelementptr (%parent, %parent* null, i32 1) to i64), i1 false)
      call void @llvm.dbg.declare(metadata %child* %child1, metadata !62, metadata !DIExpression()), !dbg !63
      %4 = bitcast %child* %child1 to i8*
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %4, i8* align [filtered] bitcast (%child* @__child__init to i8*), i64 ptrtoint (%child* getelementptr (%child, %child* null, i32 1) to i64), i1 false)
      ...
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %5, i8* align [filtered] bitcast (%grandchild* @__grandchild__init to i8*), i64 ptrtoint (%grandchild* getelementptr (%grandchild, %grandchild* null, i32 1) to i64), i1 false)
      ...
      store i32 1, i32* %a, align [filtered], !dbg !69
      ...
      store i32 2, i32* %a1, align [filtered], !dbg !70
      %b = getelementptr inbounds %child, %child* %child1, i32 0, i32 1, !dbg !71
      store i32 3, i32* %b, align [filtered], !dbg !71
      ...
      store i32 4, i32* %a3, align [filtered], !dbg !72
      ...
      store i32 5, i32* %b5, align [filtered], !dbg !73
      %c = getelementptr inbounds %grandchild, %grandchild* %grandchild1, i32 0, i32 1, !dbg !74
      store i32 6, i32* %c, align [filtered], !dbg !74
      ...
      store i32 7, i32* %a6, align [filtered], !dbg !75
      ...
      store i32 8, i32* %a9, align [filtered], !dbg !76
      ...
      store i32 9, i32* %b11, align [filtered], !dbg !77
      ...
      store i32 10, i32* %a15, align [filtered], !dbg !78
      ...
      store i32 11, i32* %b18, align [filtered], !dbg !79
      ...
      store i32 12, i32* %c20, align [filtered], !dbg !80
      ...
      store i32 13, i32* %a22, align [filtered], !dbg !81
      ...
      store i32 14, i32* %a25, align [filtered], !dbg !82
      ...
      store i32 15, i32* %b27, align [filtered], !dbg !83
      ...
      store i32 16, i32* %a31, align [filtered], !dbg !84
      ...
      store i32 17, i32* %b34, align [filtered], !dbg !85
      ...
      store i32 18, i32* %c36, align [filtered], !dbg !86
      ...
      store i32 19, i32* %a38, align [filtered], !dbg !87
      ...
      store i32 20, i32* %a41, align [filtered], !dbg !88
      ...
      store i32 21, i32* %b43, align [filtered], !dbg !89
      ...
      store i32 22, i32* %a47, align [filtered], !dbg !90
      ...
      store i32 23, i32* %b50, align [filtered], !dbg !91
      ...
      store i32 24, i32* %c52, align [filtered], !dbg !92
      %main_ret = load i32, i32* %main, align [filtered], !dbg !93
    ...
    entry:
      %self = alloca %__vtable_grandchild*, align [filtered]
      store %__vtable_grandchild* %0, %__vtable_grandchild** %self, align [filtered]
      %deref = load %__vtable_grandchild*, %__vtable_grandchild** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_grandchild, %__vtable_grandchild* %deref, i32 0, i32 0
      store void (%grandchild*)* @grandchild, void (%grandchild*)** %__body, align [filtered]
      ret void
    }

    define void @__init_grandchild(%grandchild* %0) {
    entry:
      %self = alloca %grandchild*, align [filtered]
      store %grandchild* %0, %grandchild** %self, align [filtered]
      %deref = load %grandchild*, %grandchild** %self, align [filtered]
      %__child = getelementptr inbounds %grandchild, %grandchild* %deref, i32 0, i32 0
      call void @__init_child(%child* %__child)
      %deref1 = load %grandchild*, %grandchild** %self, align [filtered]
      ...
      store i32* bitcast (%__vtable_grandchild* @__vtable_grandchild_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }
    ...
    !2 = !DIFile(filename: "<internal>", directory: "")
    !3 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !4)
    !4 = !DICompositeType(tag: DW_TAG_structure_type, name: "parent", scope: !2, file: !2, line: 2, size: 128, align [filtered], flags: DIFlagPublic, elements: !5, identifier: "parent")
    !5 = !{!6, !10}
    !6 = !DIDerivedType(tag: DW_TAG_member, name: "__vtable", scope: !2, file: !2, baseType: !7, size: 64, align [filtered], flags: DIFlagPublic)
    !7 = !DIDerivedType(tag: DW_TAG_typedef, name: "__POINTER_TO____parent___vtable", scope: !2, file: !2, baseType: !8, align [filtered])
    !8 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__parent___vtable", baseType: !9, size: 64, align [filtered], dwarfAddressSpace: 1)
    !9 = !DIBasicType(name: "__VOID", encoding: DW_ATE_unsigned, flags: DIFlagPublic)
    !10 = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: !2, file: !2, line: 4, baseType: !11, size: 32, align [filtered], offset: 64, flags: DIFlagPublic)
    ...
    !15 = !DICompositeType(tag: DW_TAG_structure_type, name: "child", scope: !2, file: !2, line: 8, size: 192, align [filtered], flags: DIFlagPublic, elements: !16, identifier: "child")
    !16 = !{!17, !18}
    !17 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !4, size: 128, align [filtered], flags: DIFlagPublic)
    !18 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !2, file: !2, line: 10, baseType: !11, size: 32, align [filtered], offset: 128, flags: DIFlagPublic)
    !19 = !DIGlobalVariableExpression(var: !20, expr: !DIExpression())
    !20 = distinct !DIGlobalVariable(name: "__grandchild__init", scope: !2, file: !2, line: 14, type: !21, isLocal: false, isDefinition: true)
    !21 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !22)
    !22 = !DICompositeType(tag: DW_TAG_structure_type, name: "grandchild", scope: !2, file: !2, line: 14, size: 256, align [filtered], flags: DIFlagPublic, elements: !23, identifier: "grandchild")
    !23 = !{!24, !25}
    !24 = !DIDerivedType(tag: DW_TAG_member, name: "SUPER", scope: !2, file: !2, baseType: !15, size: 192, align [filtered], flags: DIFlagPublic)
    !25 = !DIDerivedType(tag: DW_TAG_member, name: "c", scope: !2, file: !2, line: 16, baseType: !11, size: 32, align [filtered], offset: 192, flags: DIFlagPublic)
    ...
    !48 = !{null}
    !49 = !DILocalVariable(name: "array_of_parent", scope: !46, file: !2, line: 22, type: !50, align [filtered])
    !50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 384, align [filtered], elements: !51)
    !51 = !{!52}
    !52 = !DISubrange(count: 3, lowerBound: 0)
    !53 = !DILocation(line: 22, column: 4, scope: !46)
    !54 = !DILocalVariable(name: "array_of_child", scope: !46, file: !2, line: 23, type: !55, align [filtered])
    !55 = !DICompositeType(tag: DW_TAG_array_type, baseType: !15, size: 576, align [filtered], elements: !51)
    !56 = !DILocation(line: 23, column: 4, scope: !46)
    !57 = !DILocalVariable(name: "array_of_grandchild", scope: !46, file: !2, line: 24, type: !58, align [filtered])
    !58 = !DICompositeType(tag: DW_TAG_array_type, baseType: !22, size: 768, align [filtered], elements: !51)
    !59 = !DILocation(line: 24, column: 4, scope: !46)
    !60 = !DILocalVariable(name: "parent1", scope: !46, file: !2, line: 25, type: !4, align [filtered])
    !61 = !DILocation(line: 25, column: 4, scope: !46)
    !62 = !DILocalVariable(name: "child1", scope: !46, file: !2, line: 26, type: !15, align [filtered])
    !63 = !DILocation(line: 26, column: 4, scope: !46)
    !64 = !DILocalVariable(name: "grandchild1", scope: !46, file: !2, line: 27, type: !22, align [filtered])
    !65 = !DILocation(line: 27, column: 4, scope: !46)
    !66 = !DILocalVariable(name: "main", scope: !46, file: !2, line: 20, type: !11, align [filtered])
