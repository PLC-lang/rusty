...
fn super_keyword_basic_access() {
    ...
    entry:
      ...
      store i16 20, i16* %x, align [filtered]
      ret void
    }
...
fn super_without_deref() {
    ...
    entry:
      ...
      store %parent* %__parent, %parent** %p, align [filtered]
      ret void
    }
...
fn super_in_method_calls() {
    ...
    entry:
      ...
      store i16 0, i16* %parent.process, align [filtered]
      %load_value = load i16, i16* %value, align [filtered]
      %1 = sext i16 %load_value to i32
      %tmpVar = mul i32 %1, 2
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %parent.process, align [filtered]
      %parent__process_ret = load i16, i16* %parent.process, align [filtered]
    ...
    entry:
      ...
      store i16 0, i16* %child.process, align [filtered]
      %value = getelementptr inbounds %parent, %parent* %__parent, i32 0, i32 1
      %load_value = load i16, i16* %value, align [filtered]
      %1 = sext i16 %load_value to i32
      %tmpVar = add i32 %1, 5
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %child.process, align [filtered]
      %child__process_ret = load i16, i16* %child.process, align [filtered]
    ...
    entry:
      ...
      store i16 0, i16* %child.test, align [filtered]
      %call = call i16 @parent__process(%parent* %__parent)
      store i16 %call, i16* %child.test, align [filtered]
      %child__test_ret = load i16, i16* %child.test, align [filtered]
    ...
    entry:
      ...
      %__body = getelementptr inbounds %__vtable_parent, %__vtable_parent* %deref, i32 0, i32 0
      store void (%parent*)* @parent, void (%parent*)** %__body, align [filtered]
      %deref1 = load %__vtable_parent*, %__vtable_parent** %self, align [filtered]
      %process = getelementptr inbounds %__vtable_parent, %__vtable_parent* %deref1, i32 0, i32 1
      store i16 (%parent*)* @parent__process, i16 (%parent*)** %process, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      %__body = getelementptr inbounds %__vtable_child, %__vtable_child* %deref, i32 0, i32 0
      store void (%child*)* @child, void (%child*)** %__body, align [filtered]
      %deref1 = load %__vtable_child*, %__vtable_child** %self, align [filtered]
      %process = getelementptr inbounds %__vtable_child, %__vtable_child* %deref1, i32 0, i32 1
      store i16 (%child*)* @child__process, i16 (%child*)** %process, align [filtered]
      %deref2 = load %__vtable_child*, %__vtable_child** %self, align [filtered]
      %test = getelementptr inbounds %__vtable_child, %__vtable_child* %deref2, i32 0, i32 2
      store i16 (%child*)* @child__test, i16 (%child*)** %test, align [filtered]
      ret void
    }
...
fn super_in_multi_level_inheritance() {
    ...
    entry:
      ...
      store i16 0, i16* %grandparent.gp_method, align [filtered]
      %load_g_val = load i16, i16* %g_val, align [filtered]
      store i16 %load_g_val, i16* %grandparent.gp_method, align [filtered]
      %grandparent__gp_method_ret = load i16, i16* %grandparent.gp_method, align [filtered]
    ...
    entry:
      ...
      store i16 0, i16* %parent.p_method, align [filtered]
      %load_p_val = load i16, i16* %p_val, align [filtered]
      ...
      store i16 %3, i16* %parent.p_method, align [filtered]
      %parent__p_method_ret = load i16, i16* %parent.p_method, align [filtered]
    ...
    entry:
      ...
      %deref1 = load %__vtable_grandparent*, %__vtable_grandparent** %self, align [filtered]
      %gp_method = getelementptr inbounds %__vtable_grandparent, %__vtable_grandparent* %deref1, i32 0, i32 1
      store i16 (%grandparent*)* @grandparent__gp_method, i16 (%grandparent*)** %gp_method, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      store i16 (%grandparent*)* @grandparent__gp_method, i16 (%grandparent*)** %gp_method, align [filtered]
      %deref2 = load %__vtable_parent*, %__vtable_parent** %self, align [filtered]
      %p_method = getelementptr inbounds %__vtable_parent, %__vtable_parent* %deref2, i32 0, i32 2
      store i16 (%parent*)* @parent__p_method, i16 (%parent*)** %p_method, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      store i16 (%parent*)* @parent__p_method, i16 (%parent*)** %p_method, align [filtered]
      %deref3 = load %__vtable_child*, %__vtable_child** %self, align [filtered]
...
fn super_with_pointer_operations() {
    ...
    entry:
      ...
      store i16* %val, i16** %ptr, align [filtered]
      ...
      %deref = load i16*, i16** %ptr2, align [filtered]
      %load_tmpVar = load i16, i16* %deref, align [filtered]
      %1 = sext i16 %load_tmpVar to i32
      %tmpVar = add i32 %1, 5
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %val1, align [filtered]
      ret void
    }
...
fn super_in_conditionals() {
    ...
    entry:
      ...
      %load_threshold = load i16, i16* %threshold, align [filtered]
    ...
    entry:
      ...
      store void (%child*)* @child__test, void (%child*)** %test, align [filtered]
      ret void
    }
...
fn super_with_const_variables() {
    ...
    entry:
      ...
      store i16 50, i16* %current, align [filtered]
      ret void
    }
...
fn super_as_function_parameter() {
    ...
    entry:
      ...
      %ref = alloca %parent*, align [filtered]
      store %parent* %0, %parent** %ref, align [filtered]
      store i16 0, i16* %process_ref, align [filtered]
      %deref = load %parent*, %parent** %ref, align [filtered]
      %val = getelementptr inbounds %parent, %parent* %deref, i32 0, i32 1
      store i16 20, i16* %val, align [filtered]
      %process_ref_ret = load i16, i16* %process_ref, align [filtered]
    ...
    entry:
      ...
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %1, i8* align [filtered] %2, i64 ptrtoint (%parent* getelementptr (%parent, %parent* null, i32 1) to i64), i1 false)
      store i16 0, i16* %process_val, align [filtered]
      %val1 = getelementptr inbounds %parent, %parent* %val, i32 0, i32 1
      store i16 30, i16* %val1, align [filtered]
      %process_val_ret = load i16, i16* %process_val, align [filtered]
...
fn super_with_deeply_nested_expressions() {
    ...
    entry:
      ...
      store i16 0, i16* %parent.calc, align [filtered]
      %load_a = load i16, i16* %a, align [filtered]
      %1 = sext i16 %load_a to i32
      %load_b = load i16, i16* %b, align [filtered]
      %2 = sext i16 %load_b to i32
      %load_c = load i16, i16* %c, align [filtered]
      %3 = sext i16 %load_c to i32
      %tmpVar = mul i32 %2, %3
      %tmpVar1 = add i32 %1, %tmpVar
      %4 = trunc i32 %tmpVar1 to i16
      store i16 %4, i16* %parent.calc, align [filtered]
      %parent__calc_ret = load i16, i16* %parent.calc, align [filtered]
    ...
    entry:
      ...
      store i16 (%parent*)* @parent__calc, i16 (%parent*)** %calc, align [filtered]
      ret void
    }
...
fn super_in_loop_constructs() {
    ...
    entry:
      ...
      %counter = getelementptr inbounds %parent, %parent* %0, i32 0, i32 1
      %arr = getelementptr inbounds %parent, %parent* %0, i32 0, i32 2
      %load_counter = load i16, i16* %counter, align [filtered]
      %1 = sext i16 %load_counter to i32
      %tmpVar = add i32 %1, 1
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %counter, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      store void (%parent*)* @parent__increment, void (%parent*)** %increment, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      store void (%child*)* @child__process, void (%child*)** %process, align [filtered]
      ret void
    }
...
fn super_with_method_overrides_in_three_levels() {
    ...
    entry:
      ...
      store i16 0, i16* %grandparent.calculate, align [filtered]
      store i16 100, i16* %grandparent.calculate, align [filtered]
      %grandparent__calculate_ret = load i16, i16* %grandparent.calculate, align [filtered]
    ...
    entry:
      ...
      store i16 0, i16* %parent.calculate, align [filtered]
      %call = call i16 @grandparent__calculate(%grandparent* %__grandparent)
      %1 = sext i16 %call to i32
      %tmpVar = add i32 %1, 50
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %parent.calculate, align [filtered]
      %parent__calculate_ret = load i16, i16* %parent.calculate, align [filtered]
    ...
    entry:
      ...
      store i16 0, i16* %child.calculate, align [filtered]
      %call = call i16 @parent__calculate(%parent* %__parent)
      %1 = sext i16 %call to i32
      %tmpVar = add i32 %1, 25
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %child.calculate, align [filtered]
      %child__calculate_ret = load i16, i16* %child.calculate, align [filtered]
    ...
    entry:
      ...
      store i16 (%grandparent*)* @grandparent__calculate, i16 (%grandparent*)** %calculate, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      store i16 (%parent*)* @parent__calculate, i16 (%parent*)** %calculate, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      store i16 (%child*)* @child__calculate, i16 (%child*)** %calculate, align [filtered]
      ret void
    }
...
fn super_with_structured_types() {
    ...
    entry:
      ...
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %1, i8* align [filtered] bitcast (%Complex_Type* @__Complex_Type__init to i8*), i64 ptrtoint (%Complex_Type* getelementptr (%Complex_Type, %Complex_Type* null, i32 1) to i64), i1 false)
      ...
      store i16 %load_x, i16* %x, align [filtered]
      ...
      %load_y = load i16, i16* %y3, align [filtered]
      store i16 %load_y, i16* %y, align [filtered]
      ...
      %load_z = load float, float* %z5, align [filtered]
      store float %load_z, float* %z, align [filtered]
      ...
      %load_x10 = load i16, i16* %x9, align [filtered]
      store i16 %load_x10, i16* %x6, align [filtered]
      ...
      %load_z16 = load float, float* %z15, align [filtered]
      store float %load_z16, float* %z13, align [filtered]
      ret void
    }
    ...
    entry:
      %self = alloca %Complex_Type*, align [filtered]
      store %Complex_Type* %0, %Complex_Type** %self, align [filtered]
      ret void
    }
...
fn super_in_action_blocks() {
    ...
    entry:
      ...
      %tmpVar = add i32 %1, 1
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %value, align [filtered]
      ret void
    }
    ...
    entry:
      ...
      %load_value = load i16, i16* %value1, align [filtered]
      %1 = sext i16 %load_value to i32
      %tmpVar = add i32 %1, 5
      %2 = trunc i32 %tmpVar to i16
      store i16 %2, i16* %value, align [filtered]
