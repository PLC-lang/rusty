...
fn simple_overridden_method() {
    ...
    entry:
      ...
      store i16 0, i16* %A.foo, align [filtered]
      %A__foo_ret = load i16, i16* %A.foo, align [filtered]
      ret i16 %A__foo_ret
    }

    define void @B(%B* %0) {
    entry:
      %this = alloca %B*, align [filtered]
      store %B* %0, %B** %this, align [filtered]
    ...
    entry:
      ...
      %in = alloca i32, align [filtered]
      store i32 %1, i32* %in, align [filtered]
      store i16 0, i16* %B.foo, align [filtered]
      %B__foo_ret = load i16, i16* %B.foo, align [filtered]
      ret i16 %B__foo_ret
    }
    ...
    entry:
      ...
      %refInstanceA = alloca %A*, align [filtered]
      ...
      call void @llvm.memcpy.p0i8.p0i8.i64(i8* align [filtered] %1, i8* align [filtered] bitcast (%B* @__B__init to i8*), i64 ptrtoint (%B* getelementptr (%B, %B* null, i32 1) to i64), i1 false)
      store %A* null, %A** %refInstanceA, align [filtered]
      ...
      store %A* %instanceA, %A** %refInstanceA, align [filtered]
      %deref = load %A*, %A** %refInstanceA, align [filtered]
      %__vtable = getelementptr inbounds %A, %A* %deref, i32 0, i32 0
      %deref1 = load i32*, i32** %__vtable, align [filtered]
      %cast = bitcast i32* %deref1 to %__vtable_A*
      %foo = getelementptr inbounds %__vtable_A, %__vtable_A* %cast, i32 0, i32 1
      %2 = load i16 (%A*, i32)*, i16 (%A*, i32)** %foo, align [filtered]
      %deref2 = load %A*, %A** %refInstanceA, align [filtered]
      %fnptr_call = call i16 %2(%A* %deref2, i32 5)
      %3 = bitcast %B* %instanceB to %A*
      store %A* %3, %A** %refInstanceA, align [filtered]
      %deref3 = load %A*, %A** %refInstanceA, align [filtered]
      %__vtable4 = getelementptr inbounds %A, %A* %deref3, i32 0, i32 0
      %deref5 = load i32*, i32** %__vtable4, align [filtered]
      %cast6 = bitcast i32* %deref5 to %__vtable_A*
      %foo7 = getelementptr inbounds %__vtable_A, %__vtable_A* %cast6, i32 0, i32 1
      %4 = load i16 (%A*, i32)*, i16 (%A*, i32)** %foo7, align [filtered]
      %deref8 = load %A*, %A** %refInstanceA, align [filtered]
    ...
    entry:
      %self = alloca %__vtable_A*, align [filtered]
      store %__vtable_A* %0, %__vtable_A** %self, align [filtered]
      %deref = load %__vtable_A*, %__vtable_A** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_A, %__vtable_A* %deref, i32 0, i32 0
      store void (%A*)* @A, void (%A*)** %__body, align [filtered]
      %deref1 = load %__vtable_A*, %__vtable_A** %self, align [filtered]
      %foo = getelementptr inbounds %__vtable_A, %__vtable_A* %deref1, i32 0, i32 1
      store i16 (%A*, i32)* @A__foo, i16 (%A*, i32)** %foo, align [filtered]
      ret void
    }

    define void @__init___vtable_b(%__vtable_B* %0) {
    entry:
      %self = alloca %__vtable_B*, align [filtered]
      store %__vtable_B* %0, %__vtable_B** %self, align [filtered]
      %deref = load %__vtable_B*, %__vtable_B** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_B, %__vtable_B* %deref, i32 0, i32 0
      store void (%B*)* @B, void (%B*)** %__body, align [filtered]
      %deref1 = load %__vtable_B*, %__vtable_B** %self, align [filtered]
      %foo = getelementptr inbounds %__vtable_B, %__vtable_B* %deref1, i32 0, i32 1
      store i16 (%B*, i32)* @B__foo, i16 (%B*, i32)** %foo, align [filtered]
      ret void
    }

    define void @__init_b(%B* %0) {
    entry:
      %self = alloca %B*, align [filtered]
      store %B* %0, %B** %self, align [filtered]
      %deref = load %B*, %B** %self, align [filtered]
      %__A = getelementptr inbounds %B, %B* %deref, i32 0, i32 0
      call void @__init_a(%A* %__A)
      %deref1 = load %B*, %B** %self, align [filtered]
      %__A2 = getelementptr inbounds %B, %B* %deref1, i32 0, i32 0
      %__vtable = getelementptr inbounds %A, %A* %__A2, i32 0, i32 0
      store i32* bitcast (%__vtable_B* @__vtable_B_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }

    define void @__init_a(%A* %0) {
    entry:
      %self = alloca %A*, align [filtered]
      store %A* %0, %A** %self, align [filtered]
      %deref = load %A*, %A** %self, align [filtered]
      %__vtable = getelementptr inbounds %A, %A* %deref, i32 0, i32 0
      store i32* bitcast (%__vtable_A* @__vtable_A_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }
...
fn method_call_within_method() {
    ...
    entry:
      ...
      store %A* %0, %A** %this, align [filtered]
      %__vtable = getelementptr inbounds %A, %A* %0, i32 0, i32 0
      %deref = load %A*, %A** %this, align [filtered]
      %__vtable1 = getelementptr inbounds %A, %A* %deref, i32 0, i32 0
      %deref2 = load i32*, i32** %__vtable1, align [filtered]
      %cast = bitcast i32* %deref2 to %__vtable_A*
      %foo = getelementptr inbounds %__vtable_A, %__vtable_A* %cast, i32 0, i32 1
      %1 = load i16 (%A*, i32)*, i16 (%A*, i32)** %foo, align [filtered]
      %deref3 = load %A*, %A** %this, align [filtered]
    ...
    entry:
      ...
      %foo = getelementptr inbounds %__vtable_A, %__vtable_A* %deref1, i32 0, i32 1
      store i16 (%A*, i32)* @A__foo, i16 (%A*, i32)** %foo, align [filtered]
      %deref2 = load %__vtable_A*, %__vtable_A** %self, align [filtered]
      %bar = getelementptr inbounds %__vtable_A, %__vtable_A* %deref2, i32 0, i32 2
      store void (%A*)* @A__bar, void (%A*)** %bar, align [filtered]
      ret void
    }
...
fn this_is_untouched() {
    ...
    entry:
      ...
      store %B* %0, %B** %this, align [filtered]
      %__A = getelementptr inbounds %B, %B* %0, i32 0, i32 0
      %deref = load %B*, %B** %this, align [filtered]
    ...
    define void @C(%C* %0) {
    entry:
      %this = alloca %C*, align [filtered]
      store %C* %0, %C** %this, align [filtered]
    ...
    entry:
      ...
      %in = alloca i32, align [filtered]
      store i32 %1, i32* %in, align [filtered]
      store i16 0, i16* %C.foo, align [filtered]
      %deref = load %C*, %C** %this, align [filtered]
      call void @C__bar(%C* %deref)
      %C__foo_ret = load i16, i16* %C.foo, align [filtered]
      ret i16 %C__foo_ret
    }
    ...
    entry:
      ...
      %foo = getelementptr inbounds %__vtable_B, %__vtable_B* %deref1, i32 0, i32 1
      store i16 (%A*, i32)* @A__foo, i16 (%A*, i32)** %foo, align [filtered]
      %deref2 = load %__vtable_B*, %__vtable_B** %self, align [filtered]
      %bar = getelementptr inbounds %__vtable_B, %__vtable_B* %deref2, i32 0, i32 2
      store void (%B*)* @B__bar, void (%B*)** %bar, align [filtered]
      ret void
    }

    define void @__init___vtable_c(%__vtable_C* %0) {
    entry:
      %self = alloca %__vtable_C*, align [filtered]
      store %__vtable_C* %0, %__vtable_C** %self, align [filtered]
      %deref = load %__vtable_C*, %__vtable_C** %self, align [filtered]
      %__body = getelementptr inbounds %__vtable_C, %__vtable_C* %deref, i32 0, i32 0
      store void (%C*)* @C, void (%C*)** %__body, align [filtered]
      %deref1 = load %__vtable_C*, %__vtable_C** %self, align [filtered]
      %foo = getelementptr inbounds %__vtable_C, %__vtable_C* %deref1, i32 0, i32 1
      store i16 (%C*, i32)* @C__foo, i16 (%C*, i32)** %foo, align [filtered]
      %deref2 = load %__vtable_C*, %__vtable_C** %self, align [filtered]
      %bar = getelementptr inbounds %__vtable_C, %__vtable_C* %deref2, i32 0, i32 2
      store void (%C*)* @C__bar, void (%C*)** %bar, align [filtered]
      ret void
    }
    ...
    entry:
      %self = alloca %C*, align [filtered]
      store %C* %0, %C** %self, align [filtered]
      %deref = load %C*, %C** %self, align [filtered]
      %__A = getelementptr inbounds %C, %C* %deref, i32 0, i32 0
      call void @__init_a(%A* %__A)
      %deref1 = load %C*, %C** %self, align [filtered]
      %__A2 = getelementptr inbounds %C, %C* %deref1, i32 0, i32 0
      %__vtable = getelementptr inbounds %A, %A* %__A2, i32 0, i32 0
      store i32* bitcast (%__vtable_C* @__vtable_C_instance to i32*), i32** %__vtable, align [filtered]
      ret void
    }
