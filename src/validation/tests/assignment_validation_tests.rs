...
// TODO: Probably not the correct folder to place these tests in
#[test]
fn function_where_arguments_are_less_than_parameters() {
    let diagnostics = parse_and_validate_buffered(
        "
        FUNCTION main : DINT
            ...
            fn_with_three_parameters(1, 2);
            fn_with_three_parameters(1, 2, 3, 4);
        END_FUNCTION
        ...
        FUNCTION fn_with_three_parameters
            VAR_INPUT
                in_one : DINT;
            END_VAR
    ...
    error[E031]: Expected a reference for parameter inout_three because their type is InOut
       ┌─ <internal>:10:44
       │
    10 │             fn_with_three_parameters(1, 2, 3, 4);
       │                                            ^ Expected a reference for parameter inout_three because their type is InOut
