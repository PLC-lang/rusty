...
fn pointer_to_validates_assignment_of_non_pointer_sized_integers_in_initializer() {
    ...
    [
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type SINT 8 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(8:45 - 8:53),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type USINT 8 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(9:46 - 9:55),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type BYTE 8 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(10:45 - 10:53),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type INT 16 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(17:44 - 17:51),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type UINT 16 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(18:45 - 18:53),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type WORD 16 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(19:45 - 19:53),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type DINT 32 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(27:45 - 27:53),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type UDINT 32 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(28:46 - 28:55),
                    file: Some(
                        "<internal>",
                    ),
                },
        ...
        Diagnostic {
            inner: DiagnosticsInner {
                message: "The type DWORD 32 is too small to be stored in a Pointer",
                primary_location: SourceLocation {
                    span: Range(29:46 - 29:55),
                    file: Some(
                        "<internal>",
                    ),
                },
