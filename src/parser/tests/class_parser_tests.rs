...
fn method_with_defaults_can_be_parsed() {
    ...
    assert_eq!(
        method_pou.kind,
        PouType::Method { parent: "MyClass".into(), property: None, kind: DeclarationKind::Concrete }
    );
...
fn fb_method_can_be_parsed() {
    ...
    assert_eq!(
        method_pou.kind,
        PouType::Method { parent: "MyFb".into(), property: None, kind: DeclarationKind::Concrete }
    );
    let method = &unit.implementations[0];
...
fn fb_method_with_return_type_can_be_parsed() {
    ...
    assert_eq!(
        method_pou.kind,
        PouType::Method { parent: "MyShinyFb".into(), property: None, kind: DeclarationKind::Concrete }
    );
    let method = &unit.implementations[0];
...
fn program_methods_can_be_parsed() {
    ...
    assert_eq!(
        method_pou.kind,
        PouType::Method { parent: "prog".into(), property: None, kind: DeclarationKind::Concrete }
    );
    let method = &unit.implementations[0];
...
fn method_variable_blocks_can_be_parsed() {
    ...
    assert_eq!(
        fb_mthd.kind,
        PouType::Method { parent: "fb".into(), property: None, kind: DeclarationKind::Concrete }
    );
    ...
    assert_eq!(
        prg_mthd.kind,
        PouType::Method { parent: "prg".into(), property: None, kind: DeclarationKind::Concrete }
    );
