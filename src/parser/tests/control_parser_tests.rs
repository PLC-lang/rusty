...
use crate::ast::control_statements::{AstControlStatement, IfStatement};
...
fn if_stmnt_location_test() {
    ...
    if let AstStatement::ControlStatement{kind: AstControlStatement::IfStatement(IfStatement { blocks, .. }), ..} = &unit.statements[0] {
