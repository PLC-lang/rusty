        ...
        match ($left, $right) {
            (   AstStatement::LiteralInteger{value: lvalue, location: loc_left, ..},
                ...
                Ok(AstStatement::LiteralInteger{
                    id: $resulting_id, value: lvalue $op rvalue, location: SourceRange::new(loc_left.get_start() .. loc_right.get_start(), None)
                })
            },
            (   AstStatement::LiteralInteger{value: lvalue, location: loc_left, ..},
                ...
                Ok(AstStatement::LiteralReal{
                    id: $resulting_id, value: (*lvalue as f64 $op rvalue).to_string(), location: SourceRange::new(loc_left.get_start() .. loc_right.get_start(), None)
                })
            },
            (   AstStatement::LiteralReal{value: lvalue, location: loc_left, ..},
                AstStatement::LiteralInteger{value: rvalue, location: loc_right, ..}) => {
                    let lvalue = lvalue.parse::<f64>()
                        .map_err(|err| err.to_string())?;
                Ok(AstStatement::LiteralReal{
                    id: $resulting_id, value: (lvalue $op *rvalue as f64).to_string(), location: SourceRange::new(loc_left.get_start() .. loc_right.get_start(), None)
                })
            },
            (   AstStatement::LiteralReal{value: lvalue, location: loc_left, ..},
                AstStatement::LiteralReal{value: rvalue, location: loc_right, ..}) => {
                    ...
                    let rvalue = rvalue.parse::<f64>()
                        .map_err(|err| err.to_string())?;
                Ok(AstStatement::LiteralReal{
                    id: $resulting_id, value: (lvalue $op rvalue).to_string(), location: SourceRange::new(loc_left.get_start() .. loc_right.get_start(), None)
                })
            },
